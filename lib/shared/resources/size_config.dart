...
import '../common/widget/check_view_widget.dart';
...
final FlutterView flutterView = WidgetsBinding.instance.platformDispatcher.views.single;
...
get height {
  num statusBar = MediaQueryData.fromView(flutterView).viewPadding.top;
...
EdgeInsetsGeometry addPaddingForContent({required DeviceScreenType deviceScreenType, bool? isBottomSheet}) {
  return getMargin(
    isContent: deviceScreenType == DeviceScreenType.Mobile,
    vertical: isBottomSheet == true ? 0 : AppPadding.p16,
