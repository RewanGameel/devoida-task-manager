  ...
  Widget build(BuildContext context) {
    return Shimmer.fromColors(
      ...
      child: Container(
        ...
        padding: getPadding(horizontal: AppPadding.p24, vertical: AppPadding.p8),
        child: const Row(
          children: [
...
class Skeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(color: ColorManager.lightPrimary, borderRadius: BorderRadius.all(Radius.circular(AppPadding.p12))),
    );
  }
}
