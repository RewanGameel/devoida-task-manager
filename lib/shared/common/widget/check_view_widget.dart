...
class OrientationDetectorWidget extends StatefulWidget {
  ...
  const OrientationDetectorWidget({Key? key, required this.mobileWidget, this.tabletWidget, this.onChangeView}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return OrientationBuilder(
      builder: (BuildContext context, Orientation orientation) {
        if (orientation == Orientation.landscape && widget.onChangeView != null) {
          widget.onChangeView!(true);
        }
        if (orientation == Orientation.landscape || Singleton().getDeviceTabletMobile()) {
...
class ResponsiveWidget extends StatefulWidget {
  ...
  const ResponsiveWidget({this.largeScreen, this.mediumScreen, required this.smallScreen, this.onChangeView});
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (deviceType == DeviceScreenType.Desktop) {
        ...
        if (mediaQuery.orientation == Orientation.landscape) {
          return widget.mediumScreen ?? widget.largeScreen ?? widget.smallScreen;
        } else {
