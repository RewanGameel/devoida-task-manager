...
//this function to check have dialog or not
  ...
  _isCurrentDialogShow(BuildContext context) => ModalRoute.of(context)?.isCurrent != true;
  ...
  showPopupDialog(BuildContext context, StateRendererType stateRendererType, String message) {
    WidgetsBinding.instance.addPostFrameCallback((_) => showDialog(context: context, barrierColor: Colors.grey.withOpacity(.3), builder: (BuildContext context) => StateRenderer(retryActionFunction: () {}, message: message, stateRendererType: stateRendererType)));
  }
}
